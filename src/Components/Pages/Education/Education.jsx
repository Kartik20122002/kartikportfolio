...
const EducationSection = ({item})=>{
    ...
    return <>
    <div className={`w-full md:hover:scale-[1.1] transition-all duration-1000 flex flex-col rounded-lg md:my-[4rem] bg-glass bg-grey-light px-4 md:px-[2rem] py-[4rem]`}>
