...
export default function ImageSection(){
    ...
    <div ref={scope} className="flex items-start justify-center sm:mt-[4rem] overflow-hidden py-4 md:mx-0 md:mt-0 w-full h-full rounded-lg ">
        ...
        <motion.div id='outer' initial='hideTab' variants={variations} layout className="overflow-hidden origin-top bg-glass z-0 flex justify-center items-center md:items-start bg-grey-light rounded-xl shadow-md p-[2rem] w-full h-full md:h-fit md:w-1/2">
